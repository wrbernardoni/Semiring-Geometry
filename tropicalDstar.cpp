...
int main()
{
	...
	Semiring::Matrix<Semiring::ContactSemiring<Semiring::HopLimitedSemiring<5>, 10>,5,5> FourSteps;
	for (int i = 0; i < 4; i++)
	{
		FourSteps(i,i) = Semiring::ContactSemiring<Semiring::HopLimitedSemiring<5>, 10>([](unsigned int t, unsigned int d)->Semiring::HopLimitedSemiring<5>{
			if (d <= 1)
	...
	FourSteps(0,1) = Semiring::ContactSemiring<Semiring::HopLimitedSemiring<5>, 10>([](unsigned int t, unsigned int d)->Semiring::HopLimitedSemiring<5>{
		if ((t <= 2) && (t >= 0) && (d == 2))
			return Semiring::HopLimitedSemiring<5>(1);
		else
			return Semiring::HopLimitedSemiring<5>::Zero();
	...
	FourSteps(1,2) = Semiring::ContactSemiring<Semiring::HopLimitedSemiring<5>, 10>([](unsigned int t, unsigned int d)->Semiring::HopLimitedSemiring<5>{
		if ((t <= 3) && (t >= 3) && (d == 2))
			return Semiring::HopLimitedSemiring<5>(1);
		else
			return Semiring::HopLimitedSemiring<5>::Zero();
	...
	FourSteps(2,3) = Semiring::ContactSemiring<Semiring::HopLimitedSemiring<5>, 10>([](unsigned int t, unsigned int d)->Semiring::HopLimitedSemiring<5>{
		if ((t <= 10) && (t >= 6) && (d == 2))
			return Semiring::HopLimitedSemiring<5>(1);
		else
			return Semiring::HopLimitedSemiring<5>::Zero();
	...
	FourSteps(0,4) = Semiring::ContactSemiring<Semiring::HopLimitedSemiring<5>, 10>([](unsigned int t, unsigned int d)->Semiring::HopLimitedSemiring<5>{
		if ((d == 3))
			return Semiring::HopLimitedSemiring<5>(1);
		else
			return Semiring::HopLimitedSemiring<5>::Zero();
	...
	FourSteps(4,3) = Semiring::ContactSemiring<Semiring::HopLimitedSemiring<5>, 10>([](unsigned int t, unsigned int d)->Semiring::HopLimitedSemiring<5>{
		if ((t >= 8) && (d == 1))
			return Semiring::HopLimitedSemiring<5>(1);
		else
			return Semiring::HopLimitedSemiring<5>::Zero();
	...
	Semiring::Matrix<Semiring::ContactSemiring<Semiring::HopLimitedSemiring<5>, 10>,5,5> pK = Semiring::Matrix<Semiring::ContactSemiring<Semiring::HopLimitedSemiring<5>, 10>,5,5>::One() + FourSteps;
	for (int i = 0; i < 10; i++)
	{
		pK = pK * pK;
	}
